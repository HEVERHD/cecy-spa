      ...
      <div className="w-full max-w-md relative">
        ...
        >
          ...
          <div className="p-6">
            ...
            <div className="bg-[#00bcd4]/8 border border-[#00bcd4]/20 rounded-xl p-4 flex items-center gap-3 mb-5">
              <div className="w-9 h-9 rounded-full bg-[#00bcd4]/15 flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 24 24" className="w-5 h-5 text-[#00bcd4]" fill="currentColor">
              ...
              <div>
                <p className="text-sm font-medium text-[#00bcd4]">Recordatorio por WhatsApp</p>
